            ...
            <div class="modal-content">
                ...
                <div class="modal-footer d-flex">
                    <div class="pl-5 flex-grow-1">
                        <input class="form-check-input" type="checkbox" id="dingding" v-model="AssignData.is_dingding">
                        <label class="form-check-label" for="dingding">
                            推送钉钉消息给相关人员
                        </label>
                    </div>
                    <div>
...
<script>
    export default {
        ...
        mounted() {
            if (['P1', 'P2'].includes(this.bug_priority)) {
                this.AssignData.is_dingding = true;
            } else {
                this.AssignData.is_dingding = false;
            };
        },

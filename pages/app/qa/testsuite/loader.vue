  ...
  <div id="page-testcase-loader" class="container">
    ...
    <Modal :isFooter="true" :isHeaderClose="true" :modalSize="'lg'" :footerDirection="'start'" 
      ...
      <div slot="header" class="testsuite-head">
        ...
        <el-cascader
          class="ml-3 select-module" placeholder="按模块选择测试用例"
      ...
      <div slot="body">
        <ul class="ul-style-none mb-3 mx-3">
          <li class="case_text" v-for="(item,index) in TestCaseList" :key="index">
      ...
      <div slot="footer">
        <button type="button" class="btn btn-cancel" @click="ReferChecked()">提交已选用例</button>
        <button type="button" class="btn btn-cancel" @click="CaseForModuleAdd()">提交当前模块所有用例</button>
      </div>
    </Modal>
  </div>
</template>
